  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center mt-[1.37rem] font-normal font-bebas">
        ...
        <h3 className="text-h-black my-1  text-center dark:text-white text-[2.5rem] md:text-[4rem] leading-none ">
          {name}
        </h3>
        <span className="text-h-grey text-[2.5rem] text-center md:text-[4rem] leading-none">
          {role}
        </span>
      </div>
    </section>
