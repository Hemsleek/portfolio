...
const About = ({ about = "" }) => {
  return (
    <section id="about" className="mt-[13.15rem] md:pl-[5.5rem]  ">
      <div className="title flex items-center  space-x-3 text-[2rem] md:text-[4rem]">
        <h3 className="text-h-grey ">ABOUT</h3>
        <h3 className="text-h-black dark:text-white">ME</h3>
      </div>
      <p className="mt-[1.56rem] text-black dark:text-h-grey max-w-[19.5rem] md:max-w-[43.625rem]">
        {about
          ? about
