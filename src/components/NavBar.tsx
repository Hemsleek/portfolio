...
const NavBar = ({
  ...
  return (
    <nav className="px-[1rem] md:px-[3rem] xl:pl-[14.245rem] xl:pr-[10.245rem] bg-white dark:bg-transparent dark:text-white flex   items-center justify-between h-[20rem] drop-shadow-md">
      <a
        href={resumeLink}
        target="_blank"
